...
const CACHE_NAME = 'soundboard-shell-v17-page-backgrounds';
const APP_SHELL = [
  './',
  'index.html',
  'manifest.json',
  ...
  'assets/poppy/ui/action-profile.png',
  ...
  'assets/poppy/decor/background-mobile.webp',
  'assets/poppy/decor/background-desktop.webp',
